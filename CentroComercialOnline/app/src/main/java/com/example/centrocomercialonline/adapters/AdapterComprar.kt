...
class AdapterComprar (private val itemList : ArrayList<ProductosCarritoDto>, val context : Context) : RecyclerView.Adapter<AdapterComprar.MyViewHolder>() {
                    ...
                    R.id.eliminar_producto->{
                        AlertDialog.Builder(context)
                            ...
                            .setPositiveButton("Si"){
                                ...
                                db.collection("carrito_${usuarioLocal!!.email.toString()}")
